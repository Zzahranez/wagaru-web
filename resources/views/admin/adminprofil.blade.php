<nav class="navbar navbar-expand-lg navbar-light bg-light mb-4">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is('adminkelolaiuran') ? 'active' : '' }}" href="adminkelolaiuran">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown">
                    <img src="img/undraw_profile.svg" alt="Admin" class="rounded-circle mr-2" style="width: 30px;">
                    {{ Auth::check() ? Auth::user()->datapengguna->nama ?? 'Pengguna' : 'Pengguna' }}
                </a>
                ...
                <div class="card" style="background-color: #7da4a1; color: white;">
                    <div class="card" style="background-color: #7da4a1; color: white;">
                        <div class="card-body text-center">
                            ...
                            <p><strong>Nama:</strong> <span id="profileNama"></span></p> <!-- Menampilkan nama -->
                            <p><strong>Alamat:</strong> <span id="profileAlamat"></span></p> <!-- Menampilkan alamat -->
                            <p><strong>Tanggal Lahir:</strong> <span id="profileTanggalLahir"></span></p> <!-- Menampilkan tanggal lahir -->
                            <p><strong>Jenis Kelamin:</strong> <span id="profileJenisKelamin"></span></p> <!-- Menampilkan jenis kelamin -->
