...
<head>
    ...
    <title>AdminKelolaDataPengguna</title>
                    ...
                    <div class="container mt-4">
                        <div class="card mb-4 border-0 shadow animate__animated animate__fadeInDown">
                            <div class="card-body text-center">
                                <i class="fas fa-users-cog mb-3" style="font-size: 2rem; color: #7da4a1;"></i>
                                <h2 class="mb-0 font-weight-bold" style="font-size: 1.8rem;">Kelola Data Pengguna</h2>
                                <p class="text-muted mb-0" style="font-size: 1rem;">Informasi dan pengelolaan data
                                    pengguna di
                                    sistem</p>
