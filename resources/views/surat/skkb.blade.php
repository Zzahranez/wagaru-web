                ...
                <table>
                    ...
                    <td style="text-align: center; vertical-align: middle;">
                        <div id="text-header">
                            ...
                            <h6 class="kodeposlogo"><strong>Kode Pos : 36361</strong></6>
                        </div>
                    </td>
                </table>
        ...
        <div class="container">
            ...
            <div id="alamat" class="row">
                <div id="lampiran" class="col-md-6">
                    Nomor :  <br />
                    Lampiran :  <br />
                    Perihal : Surat Keterangan Berkelakuan Baik
                </div>
            ...
            <div id="penjelasan">
                <p>&emsp; &emsp; &emsp; Berdasarkan keterangan yang ada pada kami dan sepengetahuan kami, orang tersebut
                    di atas benar-benar memiliki perilaku yang baik dan belum pernah terlibat dalam tindakan kriminal
                    atau perbuatan yang melanggar norma hukum maupun sosial. Surat keterangan ini diberikan untuk
                    keperluan <strong>administratif yang bersangkutan</strong>.</p>
            </div>
