                ...
                <table>
                    ...
                    <td style="text-align: center; vertical-align: middle;">
                        <div id="text-header">
                            ...
                            <h6 class="kodeposlogo"><strong>Kode Pos : 36361</strong></h6>
                        </div>
                    </td>
                </table>
            </div>
        ...
        <div class="container">
            ...
            <div id="alamat" class="row">
                <div id="lampiran" class="col-md-6">
                    Nomor : <br />
                    Lampiran : <br />
                    Perihal : Surat Pengantar Pembuatan Kartu Keluarga
                </div>
            ...
            <div id="pembuka" class="row">
                <p>&emsp; &emsp; &emsp; Yang bertanda tangan di bawah ini, Ketua RT 19, Mendalo Darat,
            ...
            <div id="penjelasan">
                <p>&emsp; &emsp; &emsp; Berdasarkan permohonan yang diajukan, yang bersangkutan adalah warga
                    kami yang memerlukan pembuatan Kartu Keluarga. Surat pengantar ini dibuat untuk memudahkan
                    proses pembuatan Kartu Keluarga di Dinas Kependudukan dan Catatan Sipil.</p>
            </div>
    
            <div id="penutup">Demikian surat pengantar ini kami buat dengan sebenarnya, agar dapat dipergunakan
